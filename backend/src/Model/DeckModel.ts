export default class Deck {
	...
	create_deck_for_level(level: number) {
		...
		switch (level) {
			...
			case 1: { // DIFFERENT VALUE OR SUITE
				this.players_user_card = [];
				this.players_bot_1_card = [];
				this.players_bot_2_card = [];
				this.players_bot_3_card = [];
			...
			case 3: { //SUITES ALWAY VALID, IF YOU CHANGE VALUES ARE ACCEPTED ONLY THE CARD OF THE SUITE
				this.players_user_card = [];
				this.players_bot_1_card = [];
				this.players_bot_2_card = [];
				this.players_bot_3_card = [];
			...
			case 4: { //ALTERNATE FIGURE/NUMBER
				this.players_user_card = [];
				this.players_bot_1_card = [];
				this.players_bot_2_card = [];
				this.players_bot_3_card = [];
			...
			case 5: { // SAME SUITE/FIGURE NOT CONSECUTIVE
				this.players_user_card = [];
				this.players_bot_1_card = [];
				this.players_bot_2_card = [];
				this.players_bot_3_card = [];
			...
			case 6: { //DIFFERENT SUITE/VALUE BOUND +-1
				this.players_user_card = [];
				this.players_bot_1_card = [];
				this.players_bot_2_card = [];
				this.players_bot_3_card = [];
